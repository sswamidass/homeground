...
<main id="site-content" class="contact">
  <?php while ( have_posts() ) : the_post(); ?>
    <section class="contact-hero">
        <div class="container">
            <h1><?php the_title(); ?></h1>
            <?php if ( has_excerpt() ) : ?>
                <p class="contact-lead"><?php the_excerpt(); ?></p>
            <?php endif; ?>
        </div>
    </section>
                ...
                <div class="contact-info">
                    ...
                    <div class="info-cards">
                        <div class="info-card">
                            ...
                            <span class="info-note">General inquiries & support</span>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <h3>Phone</h3>
                            <p>(555) 123-4567</p>
                            <span class="info-note">Mon-Fri, 9am-5pm EST</span>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <span class="info-note">Visit by appointment</span>
                        </div>
                    </div>
    ...
    <section class="partnerships section" style="background-color: var(--sandy-beige);">
        <div class="container">
            ...
            <div class="partnerships-grid">
                <div class="partnership-card">
                    ...
                    <a href="mailto:creators@homeground.com" class="btn btn-outline">Contact Our Editorial Team</a>
                </div>
                <div class="partnership-card">
                    ...
                    <a href="mailto:roasters@homeground.com" class="btn btn-outline">Partner With Us</a>
                </div>
                <div class="partnership-card">
                    ...
                    <a href="mailto:partnerships@homeground.com" class="btn btn-outline">Explore Wholesale</a>
                </div>
            </div>
        </div>
    </section>
